...
export default function InvoiceContent({ booking, responsive }) {
    ...
    return (
        <>
            ...
            {/* GUEST + META */}
            <div
                className={`grid gap-4 mb-6 border rounded-xl p-3 ${responsive
            ...
            >
                ...
                <div
                    className={`grid gap-3 bg-muted/30 p-3 rounded-lg ${responsive ? "grid-cols-2 md:grid-cols-3" : "grid-cols-3"
                        }`}
                >
