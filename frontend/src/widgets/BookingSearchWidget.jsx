                ...
                <div className="grid grid-cols-1 gap-2 md:grid-cols-[1.3fr_1fr_auto_auto] md:items-end">
                    ...
                    <div className="relative">
                        ...
                        {showCalendar && (
                            <div
                                ref={calendarRef}
                                className="absolute -left-[20px] md:left-0 top-[calc(100%+10px)] z-[9999] md:w-[min(680px,95vw)] w-[min(680px,91vw)] rounded-2xl bg-white p-4 shadow-[0_30px_80px_-25px_rgba(0,0,0,0.25)]"
                            >
