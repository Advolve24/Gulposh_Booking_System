...
import { listUsersAdmin, getUserAdmin, listUserBookingsAdmin, listBookingsAdmin, updateUserAdmin, deleteUserAdmin,  createUserAdmin, 
  updateBookingAdmin,  getBookingAdmin, checkUserByPhoneAdmin, cancelBookingAdmin, getBirthdayGuests, getAnniversaryGuests } from "../controllers/admin.user.controller.js";
...
import { getSpecialOfferByUser, upsertSpecialOffer } from "../controllers/specialOffer.controller.js";
...
router.get("/users/anniversaries", getAnniversaryGuests);
...
router.get("/offers/:userId", getSpecialOfferByUser);
